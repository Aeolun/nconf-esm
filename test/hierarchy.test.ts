...
describe('nconf/hierarchy, When using nconf', () => {
  ...
  //     var script = path.join(__dirname, 'fixtures', 'scripts', 'nconf-hierarchical-load-save.ts');
  ...
  //     }
  //
  //     var child = spawn(path.resolve('node_modules/.bin/ts-node'), [script].concat(argv));
  //
  ...
  //   done => {
  //     var script = path.join(__dirname, 'fixtures', 'scripts', 'nconf-hierarchical-load-merge.ts');
  ...
  //     'scripts', 'nconf-hierarchical-load-merge-with-separator.ts');
  //   var argv = ['--candy--something', 'foo', '--candy--something5--second', 'bar'];
  //   var data = '';
  //   process.env.candy__bonbon = 'sweet';
  //   var child = spawn(path.resolve('node_modules/.bin/ts-node'), [script].concat(argv), {env: process.env});
  ...
  //   var script = path.join(__dirname, 'fixtures', 'scripts', 'nconf-hierarchical-defaults-merge.ts');
  //   var data = '';
  //   var child = spawn(path.resolve('node_modules/.bin/ts-node'), [script]);
  //
  //   child.stdout.on('data', function (d) {
  //     data += d;
  //   });
